...
const PortfolioComponent = () => {
  ...
  return (
      <div style={{paddingTop: 30}} id='portfolioComponent' className={styles.portfolioComponent}>
        ...
        <div className={styles.container}>
          ...
          {hide769px && <div className={styles.portfolioCards}>
            ...
            <PortfolioCard backgroundColor="#DB418C"
                           ...
                           tags={!hide1025px ? `# управление аэропортами\n# авиация` : `# управление аэропортами\n# авиация`}
          ...
          {!hide769px && <div className={styles.portfolioCards}>
            ...
            <PortfolioCard backgroundColor="#DB418C"
                           ...
                           tags={!hide391px ? `#управление аэропортами\n#авиация` : `#управление\nаэропортами\n#авиация`}
