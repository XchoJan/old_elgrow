  ...
  return (
    <div className="politicContainer">
      ...
      <div className="politicContent">
        ...
        <div className="politicItems">
          <div className="politicItem">
            <div className="politicTitle">1. Общие положения</div>
            <div className="politicText">
              1.1 ООО “Академ-Айти” (далее по тексту – Оператор) ставит
              соблюдение прав и свобод граждан одним из важнейших условий
              осуществления своей деятельности.
              <br /> 1.2 Политика Оператора в отношении обработки персональных
              данных (далее по тексту — Политика) применяется ко всей
              информации, которую Оператор может получить о посетителях
              веб-сайта advegital.com. Персональные данные обрабатывается в
              соответствии с ФЗ «О персональных данных» № 152-ФЗ.
            </div>
          </div>
          <div className="politicItem">
            <div className="politicTitle">
            ...
            <div className="politicText">
              ...
              их доступность в сети интернет по сетевому адресу advegital.com;{' '}
              <br />
              2.2 Пользователь – любой посетитель веб-сайта advegital.com;{' '}
              <br /> 2.3 Персональные данные – любая информация, относящаяся к
              Пользователю веб-сайта advegital.com; <br /> 2.4 Обработка
              персональных данных - любое действие с персональными данными,
              совершаемые с использованием ЭВМ, равно как и без их
              использования; <br /> 2.5 Обезличивание персональных данных –
              действия, результатом которых является невозможность без
              использования дополнительной информации определить принадлежность
              персональных данных конкретному Пользователю или лицу; <br /> 2.6
              Распространение персональных данных – любые действия, результатом
              которых является раскрытие персональных данных неопределенному
              кругу лиц; <br /> 2.7 Предоставление персональных данных – любые
              действия, результатом которых является раскрытие персональных
              данных определенному кругу лиц; <br /> 2.8 Уничтожение
              персональных данных – любые действия, результатом которых является
              безвозвратное уничтожение персональных на ЭВМ или любых других
              носителях.
            </div>
          </div>
          <div className="politicItem">
          ...
          <div className="politicItem">
            ...
            <div className="politicText">
              ...
              услуги. Также Оператор имеет право направлять Пользователю
              ...
              адрес <span>info@elgrow.ru</span> <br />
          ...
          <div className="politicItem">
            ...
            <div className="politicText">
              ...
              сайте advegital.com. Отправляя свои персональные данные Оператору,
          ...
          <div className="politicItem">
            ...
            <div className="politicText">
              ...
              данным неуполномоченных лиц. <br /> 6.2 Персональные данные
              Пользователя никогда, ни при каких условиях не будут переданы
              третьим лицам, за исключением случаев, связанных с исполнением
              действующего законодательства. <br /> 6.3. В случае выявления
              неточностей в персональных данных, Пользователь может
              актуализировать их, направив Оператору уведомление с помощью
              электронной почты на электронный адрес Оператора
              vashapochta@yandex.ru, либо на почтовый адрес (почтовый адрес
              можно убрать) 125167, г.Москва, ул.Пигузова д.123 оф.321, с
              пометкой «Актуализация персональных данных». <br /> 6.4 Срок
              обработки персональных данных является неограниченным.
          ...
          <div className="politicItem">
            <div className="politicTitle">7. Заключительные положения</div>
            <div className="politicText">
