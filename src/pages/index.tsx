...
const MainPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    } else if (router.asPath === '/mobile-page/brief') {
      router.push('/mobile-page/brief').then(() => setIsLoading(false));
  ...
  const hideHeader = () => {
    ...
    if (personSlider) {
      const personSliderRect = personSlider.getBoundingClientRect();
      if (personSliderRect.top <= 100 && personSliderRect.bottom >= 0) {
                                      ...
                                      <div className="website-tab_content_item">
                                        <div className="website_tab_content">
                                          <p className="website-mini_tab_content website-mini_tab_content3 active">
                                            ...
                                            Никаких готовых смет и скриптов для
                                            менеджеров по оценке нет.
                                          </p>
                                        </div>
                                        <div className="border_green"></div>
                                      </div>
